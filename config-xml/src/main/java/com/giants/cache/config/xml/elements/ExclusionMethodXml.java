 ...
 *
 */
@XmlEntity(name="exclusionMethod")
public class ExclusionMethodXml implements ExclusionMethod {

	private static final long serialVersionUID = 9081313842060596940L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ExclusionMethodXml other = (ExclusionMethodXml) obj;
		if (name == null) {
			if (other.name != null)
				return false;
