 ...
 *
 */
@XmlEntity(name="cleanMethod")
public class CleanMethodXml implements CleanMethod {

	private static final long serialVersionUID = -3124380139788237779L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CleanMethodXml other = (CleanMethodXml) obj;
		if (name == null) {
			if (other.name != null)
				return false;
